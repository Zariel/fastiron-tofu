...
type (
	addressesDataSource     struct{ device *fastiron.Device }
...
func (d *addressesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	for _, ipv6 := range []bool{false, true} {
		prefixes, err := d.device.InterfaceAddresses(ctx, m.Interface.ValueString(), ipv6)
		if err != nil {
