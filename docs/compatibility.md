...
| Jumbo frames | [Global configured mode and native query](guides/jumbo.md); configured lifecycle and reboot persistence verified; activation requires a saved configuration and reload, activation-status validation in progress |
