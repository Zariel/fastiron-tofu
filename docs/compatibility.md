...
| LLDP | [Global and Ethernet enable state with native queries](guides/lldp.md), with CLI drift repair, import, replacement, omission, deletion and reboot persistence verified |
