...
Direct hardware probes covered Ethernet and LAG updates, class deletion, unit changes and stale metadata repair. Ethernet and LAG OpenTofu lifecycles passed creation, CLI rate drift repair, class removal, unit change, import, interface replacement and deletion, with native and saved configuration checks and exact baseline restoration. LAG checks also verified retry after a rejected create and recreation after external removal of the whole policy. Both interface kinds retained their policies across reboot with identical running and saved configuration and a no-change plan. Post-reboot unit changes, narrow unknown-unicast removal and deletion also passed, with exact baseline restoration.
