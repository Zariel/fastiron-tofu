...
| IGMP snooping | Partial | [Per-VLAN overrides and queries](docs/guides/igmp-snooping.md), including inheritance. Global policy, collection discovery and additional controls remain. |
