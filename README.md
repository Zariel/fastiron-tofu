...
The current implementation includes VLAN names/existence, individual Ethernet VLAN memberships, Ethernet port names/enable state, DNS servers and discovery, LLDP, PoE, routed VLAN interfaces and their IPv4/IPv6 addresses, configuration saves, and firmware discovery. See [supported features and tested compatibility](docs/compatibility.md).
