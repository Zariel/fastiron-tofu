...
| LAGs | Partial | [Static/dynamic mode, name, members and native discovery](docs/guides/lags.md). Detached ports become disabled. Retained entries can require CLI restoration after external deletion; RESTCONF deletion can also require CLI cleanup, including during replacement. |
