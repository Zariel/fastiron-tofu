...
| IGMP snooping | Partial | [Global policy, per-VLAN overrides and queries](docs/guides/igmp-snooping.md), including inheritance. Collection discovery and additional controls remain. |
