...
| Spanning tree | Partial | [Native queries, VLAN STP/RSTP mode and priority, and Ethernet protection flags](docs/guides/spanning-tree.md). VLAN priority drift recovery is verified; interface lifecycle and reboot validation passed. Global STP and MST remain. |
