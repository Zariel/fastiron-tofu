...
| LLDP | Partial | [Global and Ethernet enable state with native queries](docs/guides/lldp.md), including lifecycle and reboot validation. MED policy queries are implemented; MED resources and neighbor discovery remain. |
