...
| OSPF | Partial | Default-VRF areas, VE/Ethernet/LAG bindings, and single/all-area queries. Routed binding creation and deletion verified; VE reboot persistence verified; additional routing options remain. |
