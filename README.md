...
| LAGs | Partial | [Static/dynamic mode, name, members and native discovery](docs/guides/lags.md), including interface description and administrative-state queries. Mode replacement with STP policy is verified. Detached ports become disabled. Retained entries can require CLI restoration after external deletion. Aggregate interface description and administrative-state writes remain. |
