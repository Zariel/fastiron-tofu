...
| LAGs | Partial | [Static/dynamic mode, name, members, interface description and administrative state](docs/guides/lags.md), with native queries. Mode replacement with STP policy is verified. Detached ports become disabled. Retained entries can require CLI restoration after external deletion. |
