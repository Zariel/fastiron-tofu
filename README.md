...
| LAGs | Implemented | [Static/dynamic mode, name, members and native discovery](docs/guides/lags.md). Detached ports become disabled. A retained RESTCONF entry can require CLI restoration after external deletion. |
