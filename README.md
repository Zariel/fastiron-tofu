...
| IGMP snooping | Partial | [Per-VLAN mode and version overrides](docs/guides/igmp-snooping.md), including inheritance. Global policy, discovery and additional controls remain. |
