...
The current implementation includes VLAN names/existence, individual Ethernet VLAN memberships, Ethernet port names/enable state, DNS servers and discovery, LLDP, PoE, configuration saves, and firmware discovery. Full provider scope is still in progress.
